...
export default function Settings({ onSave }) {
  ...
  return (
    <div className="max-w-2xl space-y-4 animate-fade-in">
      ...
      <KeyInput label="NVIDIA API Key" sub="Free credits at build.nvidia.com — runs NVIDIA Nemotron / Mistral (auto-fallback if a model is retired)" val={nvidiaKey} setVal={setNvidiaKey} testing={testingN} testResult={testN} onTest={doTestNvidia} placeholder="nvapi-..." />
      <Card>
